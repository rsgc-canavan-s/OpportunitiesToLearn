...
var myPlans = ("Go to dinner, see a movie, hangout, sleep")
var friendPlan = myPlans

// Update `myPlans` here:
myPlans + (", go to an IHOP at midnight")
...
func addDance(danceTalk: String) -> String {
    var speak : String = ""
    speak = ("We shall speak brifely")
    speak + (", and then we will dance!")
    return speak
}
