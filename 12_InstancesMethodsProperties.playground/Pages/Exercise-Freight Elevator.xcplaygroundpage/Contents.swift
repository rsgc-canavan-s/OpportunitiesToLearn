...
let mediocreRope = TreehousePulley(weightCapacity: 200 * 10)
var weight = food + food + food + books + books + piano

let canItHandle = mediocreRope.canHandleAdditionalLoad(weight)
